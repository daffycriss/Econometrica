...
public class PlotPanel extends javax.swing.JFrame {
    ...
    /* Δημιουργία 2 λιστών για την διαχείριση των δεδομένων GDP & OIL */
    List<CountryData> GDPData = new ArrayList();
    List<CountryData> OILData = new ArrayList();
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy");

    /* Ο constructor της PlotPanel δέχεται ως όρισμα το όνομα της χώρας 
       για την οποία θέλουμε να εμφανίσουμε τα δεδομένα της.            */ 
    public PlotPanel(String plotcountry) throws ParseException {
        initComponents();
        /* Οριζουμε τον τίτλο του γραφήματος  */
        ...
        /* Ελέγχουμε αν η χώρα υπάρχει αποθηκευμένη στην βάση δεδομένω. */
        if (!countries.isEmpty()) {
            countries.get(0).getIsoCode();
        /* Για την επιλεγμένη χώρα ανακτούμε τα συνδεδεμένα Datasets βάση του 
           πλήθους τους */
            ...
            /* Για κάθε dataset ανακτούμε τα αναλυτικά δεδομένα και ενημερώνουμε 
               τις σχετικές λίστες δεδομένων   */
...
//*****************************************************************************
        /*Δημιουργία του dataset για την εμφάνιση των δεδομένων τύπου GDP */
        ...
        /* Δημιουργία plot για το γράφημα, αρχικοποίηση axis, σύνδεση με το
           αντίστοιχο dataset και ενημέρωση του plot */
        ...
        /* Δημιουργία renderer για το plot */
        XYItemRenderer renderer = plot.getRenderer();
        renderer.setBaseToolTipGenerator(StandardXYToolTipGenerator.getTimeSeriesInstance());
        
        /* Καθορισμός γραμμών και σημείων τύπου diamond για το GDP */
        ...
        /* Δημιουργία renderer2 για το plot */
        /* Καθορισμός γραμμών και σημείων τύπου diamond για το Oil */
...
//*****************************************************************************
    ...
    /* Δημιουργία Dataset1 για την συλλογή των δεδομένων τύπου GDP */
    ...
    /* Δημιουργία Dataset2 για την συλλογή των δεδομένων τύπου Oil */
